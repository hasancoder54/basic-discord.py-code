...
def index():
    if 'token' in session:
        ...
        # Sadece yönetici yetkisi (0x8) olanları filtrele
...
async def manage(guild_id):
    ...
    try:
        ...
        # GÜVENLİK 2: Kullanıcı gerçekten bu sunucuda yönetici mi?
        ...
        if not guild_obj: return "🤖 Bot sunucuda bulunamadı."
